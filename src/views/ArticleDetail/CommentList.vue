...
<div class="cmt-box van-hairline--top" v-else>
    <textarea v-fofo  v-model="comValue"  @blur="blurFn" placeholder="友善评论、理性发言、阳光心灵"></textarea>
...
<script>
import { commentListAPI, commentDisLikingAPI, commentLikingAPI, sendCommentAPI } from '@/api'
