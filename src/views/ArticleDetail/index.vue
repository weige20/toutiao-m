    ...
    <div class="article-container">
      ...
      <div class="like-box">
        <van-button icon="good-job" type="danger" size="small"  v-if="artObj.attitude === 1"
                @click="loveFn(false)">取消点赞</van-button>
        <van-button
        icon="good-job-o"
        type="danger"
        plain
...
import { articleDetailAPI, followedUserAPI, unFollowedUserAPI, articleDisLikeAPI, articleLikeAPI } from '@/api'
...
export default {
  ...
  methods: {
    async  articleDetail () {
      ...
      // console.log(this.artObj.content)
    },
    // 作者关注/取关
